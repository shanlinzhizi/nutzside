...
<link href="${base}/resthemes/default/style.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="${base}/resthemes/css/core.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="${base}/resthemes/css/print.css" rel="stylesheet" type="text/css" media="print"/>
<link href="${base}/resuploadify/css/uploadify.css" rel="stylesheet" type="text/css" media="screen"/>
<!--[if IE]>
<link href="themes/css/ieHack.css" rel="stylesheet" type="text/css" media="screen"/>
<![endif]-->

<script src="${base}/resjs/speedup.js" type="text/javascript"></script>
<script src="${base}/resjs/jquery-1.7.2.js" type="text/javascript"></script>
<script src="${base}/resjs/jquery.cookie.js" type="text/javascript"></script>
<script src="${base}/resjs/jquery.validate.js" type="text/javascript"></script>
<script src="${base}/resjs/jquery.bgiframe.js" type="text/javascript"></script>
<script src="${base}/resxheditor/xheditor-1.1.14-zh-cn.min.js" type="text/javascript"></script>
<script src="${base}/resuploadify/scripts/swfobject.js" type="text/javascript"></script>
<script src="${base}/resuploadify/scripts/jquery.uploadify.v2.1.0.js" type="text/javascript"></script>

<!-- svg图表  supports Firefox 3.0+, Safari 3.0+, Chrome 5.0+, Opera 9.5+ and Internet Explorer 6.0+ -->
<script type="text/javascript" src="${base}/reschart/raphael.js"></script>
<script type="text/javascript" src="${base}/reschart/g.raphael.js"></script>
<script type="text/javascript" src="${base}/reschart/g.bar.js"></script>
<script type="text/javascript" src="${base}/reschart/g.line.js"></script>
<script type="text/javascript" src="${base}/reschart/g.pie.js"></script>
<script type="text/javascript" src="${base}/reschart/g.dot.js"></script>

<script src="${base}/resjs/dwz.core.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.util.date.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.validate.method.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.regional.zh.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.barDrag.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.drag.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.tree.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.accordion.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.ui.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.theme.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.switchEnv.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.alertMsg.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.contextmenu.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.navTab.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.tab.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.resize.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.dialog.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.dialogDrag.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.sortDrag.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.cssTable.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.stable.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.taskBar.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.ajax.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.pagination.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.database.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.datepicker.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.effects.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.panel.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.checkbox.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.history.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.combox.js" type="text/javascript"></script>
<script src="${base}/resjs/dwz.print.js" type="text/javascript"></script>
<!--
