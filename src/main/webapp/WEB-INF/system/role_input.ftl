...
<script type="text/javascript" src="${base}/res/template/common/js/jquery.tools.js"></script>
<script type="text/javascript" src="${base}/res/template/common/js/jquery.validate.js"></script>
<script type="text/javascript" src="${base}/res/template/common/js/jquery.validate.methods.js"></script>
<script type="text/javascript" src="${base}/res/template/admin/js/base.js"></script>
<script type="text/javascript" src="${base}/res/template/admin/js/admin.js"></script>
