...
<link href="res/template/admin/css/base.css" rel="stylesheet" type="text/css" />
<link href="res/template/admin/css/admin.css" rel="stylesheet" type="text/css" />
	...
	<div class="body">
		<form id="login_form" action="#" method="post">
            <table class="loginTable">
            	<tr>
            		<td rowspan="3">
            			<img src="${base}/res/template/admin/images/login_logo.gif" alt="管理中心" />
            		</td>
                    <th>
                    	用户名:
                    </th>
